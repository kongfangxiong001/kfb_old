...
class EncodeQ3boy {
        ...
        function ubbEncode($str='') {
                ...
                if($this->font) {
                        ...
                        '/\[p=(\d{1,2}), null, (left|center|right)\]/i',
                        '/\[p=null, (\d+), (left|center|right)\]/i',
                        '/\[\/p\]/i',
                        '/\[float=(left|right)\]/i',
                        '/\[backcolor=rgb(\(\d{1,3}, \d{1,3}, \d{1,3}\))\]/i',
                        '/\[backcolor=(#?[a-z]*)\]/i',
                        '/\[\/backcolor\]/i'
                        ));
                        $rpl_ary = array_merge($rpl_ary,array(
                        ...
                        '<p style="line-height: \\1px; text-align: \\3;">',
                        '<p style="text-indent: \\2em; text-align: \\3;">',
                        '</p>',
                        '<span style="float: \\1;">',
                        '<font background="rgb\\1">',
                        '<font background="\\1">',
                        '</font>'
                        ));
                }
